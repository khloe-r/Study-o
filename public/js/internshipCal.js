        ...
        for (i = 0; i < events.length; i++) {
            ...
            appendPre(`<div class="box my-2 pr-3 pl-3">
                        <div class="columns">
                            ...
                            <div class="column">
                            <button class="delete column" onclick="deleteApp('${event.id}')"></button>
                            </div>
                        </div>
                        <p>Due on ${theDate} at ${time} ${suffix}</p>
                        <p>${event.description}</p>
                        <button class="button mt-2" onclick="toggleModal('${event.id}', '${newDesc}')">Update Status</button>
                    </div>`)
        }
        } else {
